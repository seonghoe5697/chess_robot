...
device1 = Dobot(port="/dev/ttyUSB_ROBOT_A")  # 로봇A
device1.grip(False)   # 그리퍼 끄기 (혹시 그리퍼면)
device1.suck(False)   # 펌프 끄기
device1.close()

device2 = Dobot(port="/dev/ttyUSB_ROBOT_B")  # 로봇B
device2.grip(False)   # 그리퍼 끄기 (혹시 그리퍼면)
device2.suck(False)   # 펌프 끄기
device2.close()