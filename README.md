...
* [7.개발 일정](#7개발-일정-development-timeline)
* [8.팀원 및 역할](#7팀원-및-역할-tasks)
* [9.트러블슈팅](#8트러블슈팅-trouble-shooting)
...
## 7.개발 일정 (Development Timeline)

### Phase 1 : Analysis & Design (d1~2)  
    * 요구사항 정리  
    * 아키텍처 설계

### Phase 2 : Core System (d3~4)  
    * 체스 로직 구현
    * 엔진/수 계산 연동


### Phase 3 : Hardware Integration (d5~7)    
    * 또봇 제어 / Pi 브리지  
    * 좌표 보정 / 통합 연결

### Phase 4 : Test & Presentation (d8~9)
    * 오류 수정 / 리허설
    * 최종 발표 준비
